...
const AdminDash = () => {
  ...
  const data = {
    ...
    datasets: [
      ...
      },
      {
        ...
        backgroundColor: "rgba(232, 181, 13, 0.2)",
        tension: 0.4,
      },
    ],
  };
  ...
  return (
    <div className="flex-1 p-12 bg-[#1A1A1A] min-h-screen text-white rounded-t-2xl rounded-b-2xl relative">
      {/* Stats Overview */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
        {stats.map((stat, index) => (
          <div
            key={index}
            className="bg-[#262626] p-6 rounded-lg shadow transform transition-transform hover:-translate-y-2 hover:shadow-lg"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {products.map((product, index) => (
          <div
            key={index}
            className="bg-[#262626] p-4 rounded-lg shadow transform transition-transform hover:-translate-y-2 hover:shadow-lg relative overflow-visible"
          >
            <img
              src={product.img}
              alt={product.name}
      ...
      {/* Chart Section */}
      <div className="bg-[#262626] p-6 rounded-lg shadow-lg w-full max-w-2.5xl mx-auto">
